...
%prep
%setup -q -n qtwebchannel-everywhere-src-6.6.1
cd %{_builddir}/qtwebchannel-everywhere-src-6.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707070553
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtWebChannel/6.6.1/QtWebChannel/private/qmetaobjectpublisher_p.h
/usr/include/QtWebChannel/6.6.1/QtWebChannel/private/qwebchannel_p.h
/usr/include/QtWebChannel/6.6.1/QtWebChannel/private/signalhandler_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6WebChannel.so.6.6.1
/V3/usr/lib64/libQt6WebChannelQuick.so.6.6.1
